...
function StaffField({ label, value, onChange }: {
  label: string
  value: StaffMember
  onChange: (v: StaffMember) => void
}) {
  return (
    <div>
...
function App() {
  ...
  useEffect(() => {
    ...
    listServices().then(setPastServices)
  }, [])
  ...
  async function handleThemeImage(e: React.ChangeEvent<HTMLInputElement>) {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-3xl mx-auto py-6 px-4 pb-16">
        ...
        <Card className="mb-6 shadow-sm">
          ...
          <CardContent className="space-y-4">
            ...
            <StaffField
              ...
              value={order.worshipLeader}
              onChange={v => update('worshipLeader', v)}
            />
          </CardContent>
        </Card>
        ...
        <Card className="mb-6 shadow-sm">
          <CardHeader className="pb-4">
            <CardTitle className="text-primary">Theme Image</CardTitle>
          </CardHeader>
          <CardContent>
            <div
            ...
            >
              {themePreview ? (
                <img src={themePreview} alt="Theme" className="max-h-48 mx-auto rounded" />
              ) : (
                <div className="text-muted-foreground">
                  ...
                  <p className="text-sm">Click to upload this week's theme image</p>
                </div>
              )}
              <input
                ref={fileInputRef}
        ...
        <div className="flex items-center gap-4">
          ...
          <Button
            ...
            disabled={generating || !order.date}
            variant="secondary"
            className="px-8"
          >
